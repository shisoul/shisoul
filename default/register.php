<div class="theme-inner-banner" style="background: linear-gradient( #fff,#f5f6fa,#fff);">
    ...
    <div class="container account-css">
        <h2 class="intro-title text-center">用户注册</h2>
        <p class="text-center">
    ...
    <div class="main-content">
            ...
            <div class="formDiv">
                ...
                <div class="form-item">
                    <div class="input-warp">
                        ...
                        <input id="Password" type="Password" placeholder="密码至少6位字母或数字" maxlength="20" name="Password" value="" class="inputs" />
                    </div>
                ...
                <?php if (get_set('cps_on') == 'on') : ?>
                    <div class="form-item">
                        <div class="input-warp">
                            <span class="input-icon iconfont icon-yanzhengma"></span>

                            <input id="cps" type="text" placeholder="邀请码，可不填" maxlength="20" name="cps" value="<?php echo isset($_SESSION['cps']) ? $_SESSION['cps'] : ''; ?>" class="inputs" />
                        </div>
                        <p id="passwordErr2" class="errMsg"></p>
                    </div>
                <?php endif; ?>
                <div class="pretty-box">
                    <input type="checkbox" value="1" name="customCheck" id="customCheck" class="">
                    <label for="customCheck" style="font-weight: normal">我已阅读并同意用户协议和隐私政策</label>
                </div>
                <div class="btn-warp">
                    <div class="text-center">
                        <button type="button" id="sendreg" class="btn lgbtn blue w-100">注册</button>
                ...
                <div class="agreement gap">
                    <div class="text-center">
                        <p>
                            注册即代表您已阅读并同意《<a href="/agreement/legal" target="_blank" class="link">用户协议</a>》和《<a href="/agreement/privacy" target="_blank" class="link">隐私政策</a>》
                        </p>
                    </div>
                </div>
            </div>
        <?php else : ?>
            <div class="text-center">
                <?php echo get_set('user_reg_off_msg'); ?>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<script>
    ...
    $("#sendreg").click(function() {
        ...
        if (!$('#customCheck').prop('checked')) {
            swal({
                text: "请先阅读并勾选</br>\"我已阅读并同意用户协议和隐私政策\"",
                title: "出错啦",
                type: "error",
                confirmButtonText: "我再试试"
            });
        ...
        function get_reg(res = []) {
            ...
            $("#sendreg").html('<span class="spinner-border spinner-border-sm mr-2" role="status" aria-hidden="true"></span> ' + "正在注册...");
            $.ajax({
                url: "./reg.api",
                type: "POST",
                dataType: "json",
